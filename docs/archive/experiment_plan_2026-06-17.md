# Archived: Original Experiment Plan

Archived on 2026-06-21. This file captures the original phase boundary and
first expansion queue. Keep it for historical context; use
`docs/experiment_plan.md` for the maintained current roadmap.
