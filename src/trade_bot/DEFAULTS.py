...
DEFAULT_DASHBOARD_APP_PATH = Path("src/trade_bot/dashboard/app.py")
DEFAULT_DASHBOARD_V2_APP_PATH = Path("src/trade_bot/dashboard_v2/app.py")
DEFAULT_DASHBOARD_PORT = 8501
DEFAULT_DASHBOARD_PID_PATH = Path("reports/streamlit.pid")
DEFAULT_DASHBOARD_LOG_PATH = Path("reports/streamlit.log")
DEFAULT_DASHBOARD_V2_PID_PATH = Path("reports/streamlit-v2.pid")
DEFAULT_DASHBOARD_V2_LOG_PATH = Path("reports/streamlit-v2.log")
DEFAULT_EXPERIMENTS_DIR = Path("reports/experiments")
DEFAULT_LEGACY_EXPERIMENTS_DIR = Path("data/experiments_reset_v2")
DEFAULT_RESET_EXPERIMENTS_DIR = Path("data/experiments_close_safe_v22")
DEFAULT_ML_DIAGNOSTICS_DIR = Path("data/ml_diagnostics/latest")
DEFAULT_SIGNAL_EVIDENCE_DIR = Path("reports/signal_evidence")
DEFAULT_EXTERNAL_MACRO_TRANSCRIPT_DIR = Path("data/external/42macro_transcripts")
DEFAULT_EXTERNAL_MACRO_ALIGNMENT_DIR = Path("reports/42macro_alignment")
DEFAULT_STRATEGY_SOURCE_AUDIT_DIR = Path("reports/strategy_source_audit")
...
DEFAULT_SNAPSHOT_RETENTION_KEEP_LATEST = 12
DEFAULT_SNAPSHOT_RETENTION_KEEP_PER_MARKET_DATE = 1
DEFAULT_SNAPSHOT_RETENTION_KEEP_RECENT_MARKET_DAYS = 30
DEFAULT_SNAPSHOT_RETENTION_KEEP_WEEKLY_OLDER = 1
DEFAULT_SNAPSHOT_RETENTION_WEEKLY_FREQUENCY = "W-WED"
DEFAULT_SNAPSHOT_BACKFILL_YEARS = 2
DEFAULT_SNAPSHOT_BACKFILL_DAILY_TAIL_DAYS = 30
DEFAULT_SNAPSHOT_BACKFILL_MARKET_CLOSE_UTC_HOUR = 22
...
# default because it approximates regular deposits into the accounts in scope.
...
DEFAULT_FORWARD_SIMULATION_VALIDATION_ORIGIN_FREQUENCY = "quarterly"
...
DEFAULT_FORWARD_SIMULATION_VALIDATION_MIN_TRAIN_DAYS = 252
DEFAULT_FORWARD_SIMULATION_VALIDATION_INTERVAL_LOW = 0.20
DEFAULT_FORWARD_SIMULATION_VALIDATION_INTERVAL_HIGH = 0.80
DEFAULT_FORWARD_SIMULATION_VALIDATION_RAMP_DRAWDOWN_LIMIT = -0.10
DEFAULT_FORWARD_SIMULATION_VALIDATION_RAMP_SEVERE_PROBABILITY = 0.15
DEFAULT_FORWARD_SIMULATION_VALIDATION_WAIT_SEVERE_PROBABILITY = 0.35
...
DEFAULT_LAUNCH_AGGREGATE_MAX_STRATEGIES = 25
DEFAULT_LAUNCH_PROTOCOL_SMALL_SPREAD = 0.005
DEFAULT_LAUNCH_PROTOCOL_MATERIAL_SPREAD = 0.02
