...
def test_dashboard_app_renders_action_headline(
    ...
    assert any("Main Driver Station" in markdown.value for markdown in app.markdown)
    ...
    assert any("dashboard_main_station_nav" in markdown.value for markdown in app.markdown)
