...
BOOK_ALIGNMENT_COLUMN_HELP = {
    ...
    "account_value_input": "Raw account value supplied by Forward Test or the latest saved decision snapshot.",
    "account_value_source": "Whether book math used the supplied account value or a marked-holdings floor because logged holdings exceeded the supplied value.",
    "account_value_warning": "Warning shown when logged holdings are inconsistent with the supplied account value.",
