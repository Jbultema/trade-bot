...
METRIC_EXPLAINERS: tuple[MetricExplainer, ...] = (
    ...
    MetricExplainer(
        ...
        how_to_read="Lower usually means fewer trades, less friction, and better IRA usability.",
    ...
    MetricExplainer(
        ...
        aliases=("risk_contribution_pct", "annualized_vol_contribution", "marginal_risk_contribution"),
    ),
    MetricExplainer(
