...
DEFAULT_M6_CONFIG_PATH = Path("configs/m6.yaml")
...
DEFAULT_M6_OUTPUT_DIR = Path("reports/m6_lab")
...
DEFAULT_FORWARD_SIMULATION_VALIDATION_INTERVAL_LOW = 0.10
DEFAULT_FORWARD_SIMULATION_VALIDATION_INTERVAL_HIGH = 0.90
